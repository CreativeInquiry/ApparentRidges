...
Please also checkout the full [API Documentation](https://creativeinquiry.github.io/ApparentRidges/docs/pages/apparentridges/index.html). This section covers a typical usage example.
