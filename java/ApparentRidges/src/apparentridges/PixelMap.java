...
public class PixelMap extends haxe.lang.HxObject
{
			...
			while (( _g < _g1 ))
			{
				int y = _g++;
				{
					...
					while (( _g2 < _g3 ))
					{
						...
						hitNode[0] = new apparentridges.PixelMap_raycast_1683__Fun(r_tmin, r_tmax, r_o, r_d, hitNode, bvh);
	...
	public static double[] depth(apparentridges.Render render, java.lang.Object normalize)
	{
		...
		apparentridges.PixelMap.raycast(render, new apparentridges.PixelMap_depth_1697__Fun(render, min, max, data));
		if (normalize1) 
		{
			int _g = 0;
	...
	public static double[] normal(apparentridges.Render render)
	{
		...
		double[] data = ((double[]) (this1) );
		apparentridges.PixelMap.raycast(render, new apparentridges.PixelMap_normal_1722__Fun(render, data));
		return data;
	}
	...
	public static double[] curvature(apparentridges.Render render)
	{
		...
		double[] data = ((double[]) (this1) );
		apparentridges.PixelMap.raycast(render, new apparentridges.PixelMap_curvature_1747__Fun(render, data));
		return data;
	}
	...
	public static double[] lambertian(apparentridges.Render render, double[] light, java.lang.Object normalize)
	{
		...
		double[] min = new double[]{((double) (java.lang.Double.POSITIVE_INFINITY) )};
		double[] max = new double[]{((double) (java.lang.Double.NEGATIVE_INFINITY) )};
		apparentridges.PixelMap.raycast(render, new apparentridges.PixelMap_lambertian_1775__Fun(render, min, max, light, data));
		if (normalize1) 
		{
			int _g = 0;
			int _g1 = ((double[]) (data) ).length;
	...
	public static double[] ambientOcclusion(apparentridges.Render render, java.lang.Object numSamples, java.lang.Object normalize)
	{
		...
		double[] min = new double[]{((double) (java.lang.Double.POSITIVE_INFINITY) )};
		double[] max = new double[]{((double) (java.lang.Double.NEGATIVE_INFINITY) )};
		apparentridges.PixelMap.raycast(render, new apparentridges.PixelMap_ambientOcclusion_1808__Fun(render, numSamples1, min, max, data));
		if (normalize1) 
		{
			int _g = 0;
			int _g1 = ((double[]) (data) ).length;
