...
public class PixelMap_raycast_2138__Fun extends haxe.lang.Function
{
	public PixelMap_raycast_2138__Fun(double r_tmin, double r_tmax, double[] r_o, double[] r_d, haxe.lang.Function[] hitNode, apparentridges.BVHTree bvh)
	{
		super(1, 0);
		this.r_tmin = r_tmin;
		this.r_tmax = r_tmax;
