...
public class PixelMap_lambertian_1783__Fun extends haxe.lang.Function
{
	public PixelMap_lambertian_1783__Fun(apparentridges.Render render, double[] min, double[] max, double[] light, double[] data)
	{
		super(3, 0);
		this.render = render;
		this.min = min;
