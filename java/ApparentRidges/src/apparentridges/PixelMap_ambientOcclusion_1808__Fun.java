...
public class PixelMap_ambientOcclusion_1808__Fun extends haxe.lang.Function
{
	public PixelMap_ambientOcclusion_1808__Fun(apparentridges.Render render, int numSamples1, double[] min, double[] max, double[] data)
	{
		super(3, 0);
		this.render = render;
		...
		else
		{
			...
			int cnt = 0;
			{
				...
				while (( _g < _g1 ))
				{
					...
					hitNode[0] = new apparentridges.PixelMap_ambientOcclusion_1831__Fun(r_tmin, r_tmax, r_o, r_d, hitNode, bvh);
