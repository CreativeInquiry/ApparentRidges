...
public class PixelMap_depth_1697__Fun extends haxe.lang.Function
{
	public PixelMap_depth_1697__Fun(apparentridges.Render render, double[] min, double[] max, double[] data)
	{
		super(3, 0);
		this.render = render;
		this.min = min;
